...
try:
    opts, args = getopt.getopt(argv, "h",["data_dir=", "input_data_dir=","dem_file_name=",                                           "temper_dir=", "temper_prefix=",                                          "precip_dir=", "precip_prefix=",                                           "sol_dir=", "sol_prefix=",                                         "prcp_days_dir=","prcp_days_prefix=",                                          "snow_dir=", "snow_prefix=",                                          "wind_speed_dir=", "wind_speed_prefix=",                                          "sand_dir=", "sand_file_name=",                                          "silt_dir=","silt_file_name=",                                          "clay_dir=", "clay_file_name=",                                          "som_dir=", "som_file_name=",                                         "fvc_dir=","fvc_prefix=", "sl_output_suffix="                                         ])
...
input_data_path = os.path.join(input_dir)
